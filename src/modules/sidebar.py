...
class Sidebar:
    ...
    def about():
        ...
        sections = [
            "#### LoopGPT is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
    ...
    def show_options(self):
        with st.sidebar.expander("🛠️ LoopGPT Tools", expanded=False):
